...
* resource/aws_appmesh_virtual_node: Number of default backends per virtual node increased up to 50 ([#19423](https://github.com/hashicorp/terraform-provider-aws/issues/19423))
...
* **New Data Source:** `aws_default_tags` ([#19391](https://github.com/hashicorp/terraform-provider-aws/issues/19391))
...
* **New Data Source:** `aws_servicecatalog_constraint` ([#19499](https://github.com/hashicorp/terraform-provider-aws/issues/19499))
...
* **New Data Source:** `aws_servicecatalog_product` ([#19503](https://github.com/hashicorp/terraform-provider-aws/issues/19503))
...
* **New Resource:** `vpc_ipv6_cidr_block_association` ([#21998](https://github.com/hashicorp/terraform-provider-aws/issues/21998))
...
* data-source/aws_route: Add `carrier_gateway_id` attribute ([#16963](https://github.com/hashicorp/terraform-provider-aws/issues/16963))
* data-source/aws_route: Add `destination_prefix_list_id` attribute ([#17295](https://github.com/hashicorp/terraform-provider-aws/issues/17295))
* data-source/aws_route_table: Add `destination_prefix_list_id` attribute ([#17347](https://github.com/hashicorp/terraform-provider-aws/issues/17347))
...
* resource/aws_batch_job_definition: Add `platform_capabilities` attribute ([#16850](https://github.com/hashicorp/terraform-provider-aws/issues/16850))
...
* resource/aws_datasync_task: Add `options` `log_level` attribute ([#18932](https://github.com/hashicorp/terraform-provider-aws/issues/18932))
...
* resource/aws_default_route_table: Add `arn` attribute ([#16979](https://github.com/hashicorp/terraform-provider-aws/issues/16979))
* resource/aws_default_route_table: Add `destination_prefix_list_id` attribute ([#17319](https://github.com/hashicorp/terraform-provider-aws/issues/17319))
...
* resource/aws_instance: Add `capacity_reservation_specification` argument ([#16908](https://github.com/hashicorp/terraform-provider-aws/issues/16908))
...
* resource/aws_lakeformation_permissions: Allow `principal` to be an AWS account ID or an IAM group, ou, or organization ([#16916](https://github.com/hashicorp/terraform-provider-aws/issues/16916))
...
* resource/aws_route: Add `carrier_gateway_id` attribute ([#16961](https://github.com/hashicorp/terraform-provider-aws/issues/16961))
...
* resource/aws_route_table: Add `arn` attribute ([#16979](https://github.com/hashicorp/terraform-provider-aws/issues/16979))
* resource/aws_route_table: Add `carrier_gateway_id` attribute to `route` configuration block ([#16979](https://github.com/hashicorp/terraform-provider-aws/issues/16979))
* resource/aws_route_table: Add `destination_prefix_list_id` attribute ([#17319](https://github.com/hashicorp/terraform-provider-aws/issues/17319))
...
* resource/aws_shield_protection: Add `arn` attribute ([#19168](https://github.com/hashicorp/terraform-provider-aws/issues/19168))
* resource/aws_shield_protection: Add `tags` argument ([#19168](https://github.com/hashicorp/terraform-provider-aws/issues/19168))
* resource/aws_shield_protection: Missing resources are now detected and recreated ([#19168](https://github.com/hashicorp/terraform-provider-aws/issues/19168))
...
* resource/aws_vpc: `cidr_block` value can now either be set explicitly or computed via AWS IPAM ([#21998](https://github.com/hashicorp/terraform-provider-aws/issues/21998))
...
* resource/aws_wafv2_rule_group: Add `custom_request_handling` to `allow` and `count` rule actions. ([#19415](https://github.com/hashicorp/terraform-provider-aws/issues/19415))
* resource/aws_wafv2_rule_group: Add `custom_response` to `block` rule actions. ([#19415](https://github.com/hashicorp/terraform-provider-aws/issues/19415))
* resource/aws_wafv2_web_acl: Add `custom_request_handling` to `allow` and `count` default action and rule actions. ([#19415](https://github.com/hashicorp/terraform-provider-aws/issues/19415))
* resource/aws_wafv2_web_acl: Add `custom_response` to `block` default action and rule actions. ([#19415](https://github.com/hashicorp/terraform-provider-aws/issues/19415))
...
* aws/resource_aws_lex_bot: Fix computed `version` for dependent resources ([#20336](https://github.com/hashicorp/terraform-provider-aws/issues/20336))
...
* aws/resource_aws_lex_intent: Fix computed `version` for dependent resources ([#20336](https://github.com/hashicorp/terraform-provider-aws/issues/20336))
...
* aws/resource_aws_lex_slot_type: Fix computed `version` for dependent resources ([#20336](https://github.com/hashicorp/terraform-provider-aws/issues/20336))
...
* resource/aws_cloudwatch_event_target: Fix `ecs_target.launch_type` not allowing empty string values. ([#19555](https://github.com/hashicorp/terraform-provider-aws/issues/19555))
